...
- `bun test` — 171 pass, 0 fail, 504 assertions.
- `bun run build` — production build passed.
- `dotnet test tests/German.Application.Tests/German.Application.Tests.csproj --no-restore` — 79 pass.
...
- `dotnet test tests/German.Api.Tests/German.Api.Tests.csproj --no-restore` — 50 pass.
