...
import { buildProductionMonthlyExportUrl, buildProductionMonthlySummaryUrl, monthRangeToDateRange, productionMonthlyExportFileName } from "./productionMonthlyReport.js";
...
describe("ProductionMonthlyReportPage", () => {
  ...
  test("builds a month-scoped summary URL without changing the daily report contract", () => {
    ...
    expect(buildProductionMonthlyExportUrl("order-1", "2026-07", "2026-08", "refresh-1")).toBe(
      "/api/reports/production/monthly-summary/export.xlsx?orderId=order-1&fromMonth=2026-07&untilMonth=2026-08&exportKey=refresh-1",
    );
