...
namespace German.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922115702_AddEmployeeDateOfBirth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("German.Domain.Attendance.AttendanceDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("German.Domain.Attendance.AttendanceShiftEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SourceShiftPeriodId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AttendanceDayId", "SlotNumber")
                        .IsUnique();

                    b.ToTable("AttendanceShiftEntries");
                });
            ...
            modelBuilder.Entity("German.Domain.Auth.McpAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IssuedByUserId", "RevokedAt");

                    b.ToTable("McpAccessTokens");
                });

            modelBuilder.Entity("German.Domain.Auth.McpSessionCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("German.Domain.Production.ProductionExternalQuantity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SourceEmployeeId");

                    b.HasIndex("SubmittedByUserId");

                    b.HasIndex("ProductionOrderId", "ProductionOperationId", "ReceivedDate");

                    b.ToTable("ProductionExternalQuantities");
                });

            modelBuilder.Entity("German.Domain.Production.ProductionExternalSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProductionExternalSources");
                });
            ...
            modelBuilder.Entity("German.Domain.Attendance.AttendanceShiftEntry", b =>
                {
                    b.HasOne("German.Domain.Attendance.AttendanceDay", null)
                        .WithMany("Shifts")
            ...
            modelBuilder.Entity("German.Domain.Production.ProductionExternalQuantity", b =>
                {
                    b.HasOne("German.Domain.Production.ProductionExternalSource", null)
                        .WithMany()
                    ...
                    b.HasOne("German.Domain.Employees.Employee", null)
                        .WithMany()
                        .HasForeignKey("SourceEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);
